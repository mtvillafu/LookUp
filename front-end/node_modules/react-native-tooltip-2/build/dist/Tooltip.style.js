...
const arrowPlacementStyles = (params) => {
...
const tooltipPlacementStyles = (params) => {
...
const styleGenerator = (styleGeneratorProps) => {
    const { adjustedContentSize, displayInsets, measurementsFinished, ownProps, placement, topAdjustment, } = styleGeneratorProps;
    ...
    return {
        ...
        containerStyle: [
            styles.container,
            StyleSheet.compose(adjustedContentSize.width !== 0 &&
                measurementsFinished &&
                styles.containerVisible, topAdjustment !== 0 && {
                top: topAdjustment,
            }),
        ],
        contentStyle,
